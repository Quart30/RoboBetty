2016-01-23 18:01:11.814 xcodebuild[2764:246659] [MT] PluginLoading: Required plug-in compatibility UUID F41BD31E-2683-44B8-AE7F-5F09E919790E for plug-in at path '~/Library/Application Support/Developer/Shared/Xcode/Plug-ins/XVim.xcplugin' not present in DVTPlugInCompatibilityUUIDs
...
/Users/mrothenbuhler/.node-gyp/2.3.1/deps/v8/include/v8.h:134:7: note: 'v8::internal::Arguments' declared here
class Arguments;
      ^
In file included from ../lib/kerberos.cc:1:
...
../lib/kerberos.cc:51:15: error: calling a protected constructor of class 'v8::HandleScope'
  HandleScope scope;
              ^
/Users/mrothenbuhler/.node-gyp/2.3.1/deps/v8/include/v8.h:869:13: note: declared protected here
...
../lib/kerberos.cc:62:53: error: cannot initialize a parameter of type 'v8::Isolate *' with an lvalue of type 'Handle<v8::Value> (const v8::internal::Arguments &)'
  Local<FunctionTemplate> t = FunctionTemplate::New(Kerberos::New);
                                                    ^~~~~~~~~~~~~
/Users/mrothenbuhler/.node-gyp/2.3.1/deps/v8/include/v8.h:3871:16: note: passing argument to parameter 'isolate' here
      Isolate* isolate,
               ^
../lib/kerberos.cc:63:56: error: 'New' is a private member of 'v8::PersistentBase<v8::FunctionTemplate>'
  constructor_template = Persistent<FunctionTemplate>::New(t);
                                                       ^
/Users/mrothenbuhler/.node-gyp/2.3.1/deps/v8/include/v8.h:628:23: note: declared private here
...
gyp ERR! cwd /Users/mrothenbuhler/Code/RoboBetty/node_modules/kerberos
